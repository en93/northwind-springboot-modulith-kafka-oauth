...
public class ProductService {
    ...
    Page<ProductDTO> getProducts(String productKey, String searchProduct, Integer limit, Integer offset, SortDirectionEnumDTO sortDirection, ProductSortEnumDTO sortField) {
